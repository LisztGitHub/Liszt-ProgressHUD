...
@interface LisztIndicatorView ()

@property (nonatomic, strong) CAShapeLayer *indefiniteAnimatedLayer;

@end

@implementation LisztIndicatorView
...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        maskLayer.contents = (id)[[UIImage imageNamed:@"LisztProgressResource.bundle/angle-mask@2x.png"] CGImage];
